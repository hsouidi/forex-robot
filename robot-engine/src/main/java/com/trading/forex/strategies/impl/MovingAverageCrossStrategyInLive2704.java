...
@Slf4j
//@Service
public class MovingAverageCrossStrategyInLive2704 implements Strategy {
    ...
    private Trade check(Symbol symbol, CustomList<Candle> candleM5, CustomList<Candle> candleH1, CustomList<Candle> candleD1, CustomList<Candle> candleM15) {
        ...
        final boolean isEmaSell = h1Close<ema100H1 && close < ema100H1 && close < ema100M15 && M15Close <ema100M15;
        final boolean isEmaBuy = h1Close>ema100H1 && close > ema100H1 && close > ema100M15 && M15Close > ema100M15;
        if (
